...
//		server = getAppiumService(); // -> If using Mac, uncomment this statement and comment below statement
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH", "C:\\Users\\excel\\AppData\\Local\\Android\\Sdk\\platform-tools" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "C:\\Users\\excel\\AppData\\Local\\Android\\Sdk");
